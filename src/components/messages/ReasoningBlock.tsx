 ...
 * Used here for smooth expand/collapse animations on the reasoning steps section.
 * The reasoning block smoothly grows in height and fades in when expanded.
 * World use cases: Any interactive UI with animated reveal/collapse behavior.
 */
import { motion } from "framer-motion";

/**
 * === LUCIDE REACT — Icons ===
 * ChevronRight: Rotates 90° when expanded to indicate open/closed state.
 * Lightbulb: Icon shown when reasoning is complete ("Thought for some time").
 */
