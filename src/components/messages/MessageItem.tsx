 ...
 * Optimized image component — handles lazy loading, responsive sizing,
 * and automatic WebP/AVIF conversion for better performance.
 * Used here to display user-uploaded images in chat messages.
 */
import Image from "next/image";

/**
 * === LUCIDE REACT — Icons ===
 * Check/Copy: Copy message button states | FileIcon: File attachment indicator
 * PenSquareIcon: Edit message button | RotateCw: Regenerate response button
 */
...
/** === Local components for rendering different message part types === */
 ...
 * - InferUITool: Infers input/output types from tool definitions for type-safe rendering.
 * - UIMessage: The main message type with id, role, and parts array.
 */
import type { InferUITool, UIMessage } from "ai";

/** === Local tool definitions (for type inference only) === */
import {
  generateImageTool,
  getWeatherTool,
  webSearchTool,
 ...
 * - useMutation: For delete operations (deleting messages when regenerating).
 * - useQuery: For fetching message data (checking if regeneration target exists).
 */
...
/**
 * === SONNER ("sonner") ===
 * Toast notification for "Regenerating response" feedback.
 */
...
/** === Local hook for checking user's remaining message quota === */
